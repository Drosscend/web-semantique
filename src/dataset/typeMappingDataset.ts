...
export const KNOWN_TYPE_MAPPINGS: TypeMapping[] = [
    ...
    // Vehicles and Means of Transport
    {
        ...
        confidence: 0.95,
        description: "Mobile machine used for transport, including wheeled and tracked vehicles, air, water, and space craft",
    },
    {
        dbpediaType: "http://dbpedia.org/ontology/Automobile",
        wikidataType: "http://www.wikidata.org/entity/Q1420",
        confidence: 0.95,
        description: "Type of vehicle designed to transport people and cargo, typically with four wheels and an engine",
    },
    ...
    // Technologies and Electronic Devices
    {
        ...
        confidence: 0.95,
        description: "General-purpose device that performs arithmetic or logical operations automatically",
    },
    {
    ...
    },
    {
        ...
        confidence: 0.9,
        description: "Technology dealing with the control of electrons in electrical circuits",
    },
    ...
    // Sports
    {
        ...
        confidence: 0.95,
        description: "Form of physical activity practiced for recreation or competition",
    },
    {
        dbpediaType: "http://dbpedia.org/ontology/SportingEvent",
        wikidataType: "http://www.wikidata.org/entity/Q16510064",
        confidence: 0.9,
        description: "Event in sports, including tournaments, matches, and competitions",
    },
